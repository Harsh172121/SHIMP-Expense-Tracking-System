...
public class PieChartIncome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseHandler databaseHandler = new DatabaseHandler(PieChartIncome.this);

        addData(databaseHandler);
        getEntries();
    ...
    private class PieChartOnValueTouchListener implements PieChartOnValueSelectListener {
        ...
        public void onValueSelected(int arcIndex, SliceValue value) {
            ...
            Toast.makeText(PieChartIncome.this, toastMessage, Toast.LENGTH_SHORT).show();
        }
    ...
    private void addData(DatabaseHandler databaseHandler) {
